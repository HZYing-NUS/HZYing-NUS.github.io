  ...
  return (
    ...
    >
      <div className="mx-auto mb-12 px-4 text-center md:px-8">
        ...
        <h2 className="mb-6 text-3xl font-semibold tracking-[-0.025em] text-pretty lg:text-[3.5rem] lg:leading-[1.1]">
          {section.title}
        </h2>
            ...
            return (
              <Card
                ...
                className={cn(
                  'relative',
                  item.label &&
                    'bg-secondary border-[var(--linear-hairline-strong)]'
                )}
              >
                {item.label && (
                ...
                <CardHeader>
                  ...
                  {isCurrentPlan ? (
                    ...
                    <Button
                      ...
                      disabled={isLoading}
                      className={cn(
                        'mt-4 h-10 w-full rounded-lg px-3.5',
