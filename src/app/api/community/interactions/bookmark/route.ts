...
import { setCommunityBookmark } from '@/shared/services/community/interactions';
...
export async function PUT(request: NextRequest) {
  try {
    ...
    if (
      !['resource', 'collection', 'article', 'list'].includes(body.targetType)
    )
      return respErr('COMMUNITY_BOOKMARK_TYPE_INVALID');
    return respData(
